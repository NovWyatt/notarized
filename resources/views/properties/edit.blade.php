                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('properties.show', $asset) }}">{{ $asset->display_name }}</a></li>
                                        ...
                                        <div class="search-dropdown">
                                            <div class="input-group">
                                                <input type="text" class="form-control search-input"
                                                    id="certificate_type_search" placeholder="Tìm kiếm GCNSQH tài sản..."
                                                    autocomplete="off"
                                ...
                                <div class="col-md-4">
                                    <div class="mb-3">
                                        ...
                                        <div class="search-dropdown">
                                            <div class="input-group">
                                                <input type="text" class="form-control search-input"
                                                    id="certificate_issuing_authority_search"
                                                    placeholder="Tìm kiếm nơi cấp..." autocomplete="off"
                                                    value="{{ $certificate && $certificate->issuingAuthority ? $certificate->issuingAuthority->name : old('certificate_issuing_authority_search') }}">
                                                <button type="button" class="btn btn-outline-primary btn-create-item"
                                                    onclick="AssetManager.search.showCreateIssuingAuthorityModal()">
                                                    <i class="fas fa-plus me-2"></i>
                                                </button>
                                            </div>
                                            <input type="hidden" id="certificate_issuing_authority_id"
                                                name="certificate_issuing_authority_id"
                                                value="{{ old('certificate_issuing_authority_id', $certificate?->issuing_authority_id) }}">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="house_type" name="house_type"
                                        value="{{ old('house_type', $house?->house_type) }}" placeholder="Nhập loại nhà">
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="mb-3">
                            ...
                            <div class="col-md-3">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="number_of_floors"
                                        ...
                                        value="{{ old('number_of_floors', $house?->number_of_floors) }}" placeholder="1"
                                        min="1" max="100">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="structure" name="structure"
                                        value="{{ old('structure', $house?->structure) }}" placeholder="Nhập kết cấu">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <div class="search-dropdown">
                                        <div class="input-group">
                                            <input type="text" class="form-control search-input"
                                                id="issuing_authority_search" placeholder="Tìm kiếm cơ quan cấp phát..."
                                                autocomplete="off"
                            ...
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="payload" name="payload"
                                        value="{{ old('payload', $vehicle?->payload) }}" placeholder="0" min="0"
                                        step="0.01">
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="engine_capacity"
                                        ...
                                        value="{{ old('engine_capacity', $vehicle?->engine_capacity) }}" placeholder="0"
                                        min="0" step="0.01">
                                </div>
                            </div>
                            <div class="col-md-2">
                    ...
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="new_certificate_name" name="name" required
                                placeholder="Nhập tên gọi GCNSQH tài sản...">
                        </div>
                        <div class="mb-3">
            ...
            <div class="modal-content">
                ...
                <form id="createIssuingAuthorityForm">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="new_authority_address" class="form-label">Ghi chú</label>
                            <textarea class="form-control" id="new_authority_address" name="address" rows="2" placeholder="Ghi chú..."></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Hủy</button>

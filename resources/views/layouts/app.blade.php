...
<head>
    ...
    <!-- Toastr CSS & JS cho notifications -->
        ...
        <div class="sidebar-body pt-0 data-scrollbar">
            <div class="sidebar-list">
                ...
                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('properties*') ? 'active' : '' }}" aria-current="page" href="{{ route('properties.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ request()->is('admin/logs*') ? 'active' : '' }}" aria-current="page" href="{{ route('admin.logs.index') }}">

                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" id="show_parties"
                                                    ...
                                                    {{ old('template_settings.show_parties', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" id="show_assets"
                                                    ...
                                                    {{ old('template_settings.show_assets', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" id="show_transaction_value"
                                                    ...
                                                    {{ old('template_settings.show_transaction_value', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" id="show_clauses"
                                                    ...
                                                    {{ old('template_settings.show_clauses', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" id="show_testimonial"
                                                    ...
                                                    {{ old('template_settings.show_testimonial', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" id="show_signatures"
                                                    ...
                                                    {{ old('template_settings.show_signatures', true) ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check mb-2">
                                                <input type="checkbox" class="form-check-input" id="show_notary_info"
                                                    ...
                                                    {{ old('template_settings.show_notary_info', true) ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="required_parties_min"
                                                    ...
                                                    value="{{ old('template_settings.required_parties_min', 2) }}"
                                                    min="1" max="10">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" id="required_assets_min"
                                                    ...
                                                    value="{{ old('template_settings.required_assets_min', 1) }}"
                                                    min="0" max="10">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        <textarea class="form-control @error('content') is-invalid @enderror" id="content" name="content" rows="15"
                                            placeholder="Nhập nội dung template HTML..." required>{{ old('content') }}</textarea>
                                        @error('content')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="office_name"
                                            ...
                                            value="{{ old('template_info.office_name', 'Văn phòng công chứng Nguyễn Thị Như Trang') }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="province"
                                            ...
                                            value="{{ old('template_info.province', 'tỉnh Bình Dương') }}">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="current_user"
                                            ...
                                            value="{{ old('template_info.current_user', auth()->user()->name ?? 'Công chứng viên') }}">
                                    </div>
                                </div>
                            </div>

                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('contract_type_id') is-invalid @enderror" id="contract_type_id" name="contract_type_id" required>
                                                ...
                                                <option value="{{ $type->id }}" {{ old('contract_type_id', $contractTemplate->contract_type_id) == $type->id ? 'selected' : '' }}>
                                                    {{ $type->name }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-switch">
                                                <input type="checkbox" class="custom-control-input" id="is_active" name="is_active" value="1" {{ old('is_active', $contractTemplate->is_active) ? 'checked' : '' }}>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="show_parties" name="template_settings[show_parties]" value="1" {{ old('template_settings.show_parties', $contractTemplate->shouldShow('parties')) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="show_assets" name="template_settings[show_assets]" value="1" {{ old('template_settings.show_assets', $contractTemplate->shouldShow('assets')) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="show_transaction_value" name="template_settings[show_transaction_value]" value="1" {{ old('template_settings.show_transaction_value', $contractTemplate->shouldShow('transaction_value')) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="show_clauses" name="template_settings[show_clauses]" value="1" {{ old('template_settings.show_clauses', $contractTemplate->shouldShow('clauses')) ? 'checked' : '' }}>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="show_testimonial" name="template_settings[show_testimonial]" value="1" {{ old('template_settings.show_testimonial', $contractTemplate->shouldShow('testimonial')) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="show_signatures" name="template_settings[show_signatures]" value="1" {{ old('template_settings.show_signatures', $contractTemplate->shouldShow('signatures')) ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check mb-2">
                                            <input type="checkbox" class="form-check-input" id="show_notary_info" name="template_settings[show_notary_info]" value="1" {{ old('template_settings.show_notary_info', $contractTemplate->shouldShow('notary_info')) ? 'checked' : '' }}>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>&nbsp;</label>
                                                    <div class="custom-control custom-switch">
                                                        <input type="checkbox" class="custom-control-input" id="required{{ $index + 1 }}" name="default_clauses[{{ $index + 1 }}][is_required]" value="1" {{ old('default_clauses.' . ($index + 1) . '.is_required', $clause['is_required'] ?? false) ? 'checked' : '' }}>
...
<script>
    $(document).ready(function() {
        let clauseIndex = {
            {
                count($contractTemplate - > default_clauses)
            }
        };
        ...
        $('#previewBtn').click(function() {
            ...
            const sampleData = {
                ...
                '}}': $('#office_name').val() || 'Văn phòng công chứng'
                , '{{' {
                    {
                        office_address
                    }
                }
                '}}': $('#office_address').val() || 'Địa chỉ văn phòng'
                , '{{' {
                    {
                        province
                    }
